...
<div style="background-image: url(/images/banner/hero-bg.jpg)">
	...
	<!--End Top Header-->
	<!--Header-->
	<div class="header-wrap classicHeader animated d-flex" style="background-color: white;">
		<div class="container-fluid">
			<div class="row align-items-center">
				<!--Desktop Logo-->
				<div class="logo col-md-2 col-lg-2 d-none d-lg-block">
					<a style="text-decoration: none;" href="/"><h1 style="font-size:20px; font-weight: 600; color: rgb(39, 39, 39);	">HƯƠNG QUÊ</h1> </a>
				...
				<div class="col-2 col-sm-3 col-md-3 col-lg-8">
					...
					<nav class="grid__item" id="AccessibleNav">
						...
						<ul id="siteNav" class="site-nav medium right hidearrow">
							...
							<li class="lvl1 parent megamenu"><a href="/product/list?kw=">Thực đơn <i class="anm anm-angle-down-l"></i>
							</a>
							...
							<li class="lvl1 parent megamenu"><a href="#">Tin tức <i class="anm anm-angle-down-l"></i>
							</a>
	...
	<div class="mobile-nav-wrapper" role="navigation">
		...
		<ul id="MobileNav" class="mobile-nav">
			...
			<li class="lvl1 parent megamenu"><a href="product-layout-1.html">Tin tức <i class="anm anm-plus-l"></i>
			</a>
				<ul>
					<li><a href="product-layout-1.html" class="site-nav"> </a></li>
				</ul></li>

		...
		<div id="page-content">
			...
			<div class="product-rows section">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<h1 style="margin-bottom: 30px;margin-top: 50px;color: white">Không gian nhà hàng của chúng tôi</h1>
							...
							<div class="icon-text-container">
								...
								<h3
									style="font-style: italic; display: inline-block; vertical-align: middle; margin-left: 5px;">Bố trí bàn ghế đẳng cấp cùng với lựa chọn trang trí nội
								thất tinh tế tạo nên sự hài hòa và tạo điểm nhấn nghệ thuật cho
								không gian. Sự tinh tế và sang trọng không chỉ nằm ở thiết kế mà
								còn được thể hiện qua từng đợt phục vụ tận tâm và chất lượng.</h3>
							</div>
							<div class="icon-text-container">
								<svg xmlns="http://www.w3.org/2000/svg" width="50px"
									height="50px" style="color: #E3AB05" fill="currentColor"
								...
								<h3
									style="font-style: italic; display: inline-block; vertical-align: middle; margin-left: 5px;">Đây không chỉ là nơi dành cho bữa ăn tuyệt vời mà còn là
								trải nghiệm đẳng cấp, khiến mọi khách hàng đều cảm nhận được sự
								sang trọng và đẳng cấp từng khoảnh khắc tại nhà hàng của chúng
								tôi.</h3>
							</div>
